...
print('Saving train...')
with open(os.path.join(train_basedir, 'train.jsonl'), 'w') as fd:
    for i, row in tqdm(train_df_transplant_final.iterrows(), total=train_df_transplant_final.shape[0]):
